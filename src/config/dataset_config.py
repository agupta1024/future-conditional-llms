...
def get_dataset_config(name="tinystories", max_seq_length=1024, **_kwargs):
    ...
    if name == "tinystories":
        ...
        dataset_config = {
            ...
            "train_big_path": "./data_cache/treasure_hunt/train_big.jsonl",
        ...
        dataset_config = {
            ...
            "batch_size": 16,
            "dataset_size": 10000,
            "train_path": "./data_cache/blocksworld/train.jsonl",
            "val_path": "./data_cache/blocksworld/eval.jsonl",
            "val_4blocks_path": "./data_cache/blocksworld/blocksworld_eval_4blocks.jsonl",
            "val_6blocks_path": "./data_cache/blocksworld/eval_6.jsonl",
